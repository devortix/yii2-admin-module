            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="/" class="site_title"><i class="fa fa-angellist"></i> <span>Devortix Panel</span></a>
                    </div>
...
?>
    ...
    ['/user/logout'],
    ['title' => \Yii::t('admin-panel', 'Logout'),
        'data-toggle' => 'tooltip',
        'data-placement' => "top",
        'data-method' => 'POST',
    ])?>
...
?>
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li>
                                        <?=Html::a('<i class="fa fa-address-card-o  pull-right"></i> ' . \Yii::t('admin-panel', 'Profile'), ['/user/admin/update-profile', 'id' => \Yii::$app->user->id], ['class' => ''])?>
                                    </li>
                                    <li>
                                        <a href="javascript:;">
                                    ...
                                    <li>
                                        <?=Html::a('<i class="fa fa-sign-out pull-right"></i> ' . \Yii::t('admin-panel', 'Logout'), ['/user/logout'], ['data-method' => 'POST'])?>
